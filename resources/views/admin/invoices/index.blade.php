                ...
                <div class="row">
                    ...
                    <!-- Nav tabs -->
                        ...
                        <div class="col-md-12">
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                    <a href="{{URL::to('/add-invoice')}}"class="btn btn-primary btn-sm float-right">Add</a>
                                </div>
                            </div>
                        </div> 
                        <!-- Tab panes -->
                        <div class="tab-content m-t-10">
                            ...
                            <div class="invoice-data table-responsive active">
...
//
        ...
        $(document).on('dblclick', '#invoice-table tbody tr', function(event) {
            var invoiceId = $(this).data('id');
            if(typeof(invoiceId) !== 'undefined'){
                var url = 'invoice/'+invoiceId+'/edit';
        ...
        function getInvoiceData(qstring){
           
            $.ajax({
                url: "{{URL::to('invoice')}}?"+qstring,
                dataType: 'json',
            }).done(function(data) {
        ...
        function removeInvoice(){
            $.ajax({
                type: "DELETE",
                url: "{{URL::to('delete-invoice')}}"+'/'+invoiceId,
                dataType: 'json',
                data: {
                    "_token": "{{ csrf_token() }}"
                }
