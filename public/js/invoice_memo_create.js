    ...
    $("#addrow").click(function(){
        ...
        if (giaTypeVal && addGiaDetails) {
            ...
            $(".item-row:last").after('<tr class="item-row">\n' +
                ...
                '<input type="hidden" name="return_carat[]" class="return-carat allownumericwithdecimal" value="0">\n' +
                '<input type="hidden" name="sold_carat[]" class="sold-qty allownumericwithdecimal" value="0">\n' +
